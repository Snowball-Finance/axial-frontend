...
interface SwapGuardedInterface extends ethers.utils.Interface {
  functions: {
...
export class SwapGuarded extends Contract {
  ...
  interface: SwapGuardedInterface;
  ...
  functions: {
    ...
    "addLiquidity(uint256[],uint256,uint256,bytes32[])"(
      amounts: BigNumberish[],
      minToMint: BigNumberish,
      deadline: BigNumberish,
      merkleProof: BytesLike[],
  ...
  callStatic: {
    ...
    disableGuard(overrides?: CallOverrides): Promise<void>;
