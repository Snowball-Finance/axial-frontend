...
interface SharedStakeStakingRewardsInterface extends ethers.utils.Interface {
  functions: {
...
export class SharedStakeStakingRewards extends Contract {
  ...
  functions: {
    ...
    "notifyRewardAmount(uint256,address)"(
      reward: BigNumberish,
      rewardHolder: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
