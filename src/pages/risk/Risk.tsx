        ...
        <div className="itemInfo">
          <div className="text">
            ...
            <p data-testid="risk-intro">
              {t("riskIntro")} <a href="https://github.com/Snowball-Finance/axial-protocol">{t("riskIntro2")}</a> {t("riskIntro3")}
            </p>
          </div>
          <div className="icon">
        ...
        <div className="itemInfo">
          <div className="text">
            ...
            <p data-testid="risk-audits">
              {t("riskAudits1")} <a href="https://saddle.finance/">{t("riskAudits1LinkTitle")}</a>
              {t("riskAudits2")} <a href="https://github.com/Snowball-Finance/axial-protocol">{t("riskAudits2LinkTitle")}</a>
              <br />
              {t("riskAudits3")}
              <br />
              {t("riskAudits4")}
        ...
        <div className="itemInfo">
          <div className="text">
            ...
            <p data-testid="risk-adminkeys">
              {t("riskAdminKeys")}
              <a href="https://snowballs.gitbook.io/snowball-docs/resources/security#2-council">{t("riskAdminKeysLinkTitle")}</a>
              {t("riskAdminKeys2")}
              <a href="https://snowtrace.io/address/0xfdCcf6D49A29f435E509DFFAAFDecB0ADD93f8C0">{t("riskAdminKeys2LinkTitle")}</a>
              {t("riskAdminKeys3")}
            </p>
          </div>
          <div className="icon">
        ...
        <div className="itemInfo">
          <div className="text">
            ...
            <p>
              ...
              <br />
              <a href="https://github.com/ethereum/EIPs/issues/20#issuecomment-263524729">ERC: Token standard · Issue #20 · ethereum/EIPs</a>
            </p>
          </div>
