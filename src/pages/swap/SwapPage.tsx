      ...
      <div className="container">
        <div className="textBlock">
          ...
          <div className="description">
            <p>
              Swap stablecoins and other value-pegged assets on Axial. Swapping on Avalanche has never been cheaper, with our ultra low fees and
        ...
        <div className="swapForm">
          ...
          <div className="row">
            <SwapInput
              tokens={tokenOptions.from.filter(({ symbol }) => symbol !== toState.symbol)}
          ...
          <div className={classNames({ showError: !!error }, "error")}>{error}</div>
          <div className="change">
            {fromState.symbol && toState.symbol && (
              <button className="exchange" onClick={onClickReverseExchangeDirection}>
          ...
          <div className="row">
            <SwapInput
              tokens={tokenOptions.to.filter(({ symbol }) => symbol !== fromState.symbol)}
              ...
              <>
                ...
                {isVirtualSwap && (
                  <div className="row">
                    <span></span>
                    <span>
                      <a href="#" style={{ textDecoration: "underline" }} target="_blank" rel="noreferrer">
                        ({t("virtualSwap")})
                      </a>
                    </span>
                  </div>
                )}
                {isVirtualSwap && isHighSlippage && <div className="exchangeWarning">{t("lowSlippageVirtualSwapWarning")}</div>}
              </>
            )}
          </div>

          <AdvancedOptions noApprovalCheckbox={false} noSlippageCheckbox={false} />
          {swapError && <div className="exchangeWarning">{swapError}</div>}
