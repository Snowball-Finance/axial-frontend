      ...
      <div className="content">
            ...
            <div className={"transactionInfoContainer"}>
              <div className="transactionInfo">
                ...
                <div className="transactionInfoItem">
                  ...
                  <span className={"value " + (transactionData.priceImpact.gte(0) ? "bonus" : "slippage")}>
                    {" "}
        ...
        <Modal isOpen={!!currentModal} onClose={(): void => setCurrentModal(null)}>
          ...
          {currentModal === "confirm" && (
            <ConfirmTransaction transactionStatus={transactionStatus} type="deposit" transactionData={transactionData} />
          )}
        </Modal>
      </div>
    </div>
