  ...
  networkName === "Fuji"
    ...
    : ({
        ...
        [TokenSymbols.USDt]: {
          ...
          name: "TetherToken",
          geckoId: "tether",
          logo: iconSrcWithAddress(tokenAddress(TokenSymbols.USDt)),
          decimals: 6,
          masterchefId: -1,
          isSynthetic: false,
          isLPToken: false,
        ...
        [TokenSymbols.USDC]: {
          ...
          name: "USD Coin",
          logo: iconSrcWithAddress(tokenAddress(TokenSymbols.USDC)),
          geckoId: "usd-coin",
          masterchefId: -1,
          isSynthetic: false,
          isLPToken: false,
        ...
        [TokenSymbols.YUSD]: {
          ...
          logo: iconSrcWithAddress(tokenAddress(TokenSymbols.YUSD)),
