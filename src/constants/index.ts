...
export const AXIAL_JLP_POOL_TOKEN = new Token(AXIAL_JLP_ADDRESS, 18, "JLP", "jlpavaxaxial", "JLP AVAX-AXIAL", axialLogo, false, true, 2)
...
export const DAI = new Token(DAI_CONTRACT_ADDRESSES, 18, "DAI.e", "dai", "Dai", daiLogo, false, false)
...
export const AVAI = new Token(AVAI_CONTRACT_ADDRESSES, 18, "AVAI", "orca-avai", "Orca AVAI", avaiLogo, false, false)
...
export const ORCA = new Token(ORCA_CONTRACT_ADDRESSES, 18, "ORCA", "orcadao", "Orca DAO", axialLogo, false, false)
...
export const FRAX = new Token(FRAX_CONTRACT_ADDRESSES, 18, "FRAX", "frax", "Frax", fraxLogo, false, false)
...
export const TSD = new Token(TSD_CONTRACT_ADDRESSES, 18, "TSD", "teddy-dollar", "Teddy Dollar", tsdLogo, false, false)
...
export const USDC = new Token(USDC_CONTRACT_ADDRESSES, 6, "USDC", "usd-coin", "Native USDC", usdcLogo, false, false)
...
export const MIM = new Token(MIM_CONTRACT_ADDRESSES, 18, "MIM", "magic-internet-money", "Magic Internet Money", mimLogo, false, false)
...
export const TEDDY = new Token(TEDDY_CONTRACT_ADDRESS, 18, "TEDDY", "teddy", "Teddy", axialLogo, false, false)
...
export const FXS = new Token(FXS_CONTRACT_ADDRESS, 18, "FXS", "frax-share", "Frax Share", axialLogo, false, false)
...
export const WAVAX = new Token(WAVAX_CONTRACT_ADDRESS, 18, "AVAX", "avalanche-2", "Wrapped AVAX", axialLogo, false, false)
...
export const TUSD = new Token(TUSD_CONTRACT_ADDRESSES, 18, "TUSD", "true-usd", "TUSD Coin", tusdLogo, false, false)
...
export const USDT = new Token(USDT_CONTRACT_ADDRESSES, 6, "USDT.e", "tether", "Tether", usdtLogo, false, false)
...
export const USDCe = new Token(USDCe_CONTRACT_ADDRESSES, 6, "USDC.e", "usd-coin", "USDC.e", usdcLogo, false, false)
...
export const TOKEN_TO_POOLS_MAP = Object.keys(POOLS_MAP).reduce((acc, poolName) => {
  const pool = POOLS_MAP[poolName as PoolName]
  const newAcc = { ...acc }
  pool.poolTokens.forEach((token) => {
    newAcc[token.symbol] = (newAcc[token.symbol] || []).concat(poolName as PoolName)
  })
  return newAcc
}, {} as TokenToPoolsMap)
...
export const LPTOKEN_TO_POOL_MAP = Object.keys(POOLS_MAP).reduce((acc, poolName) => {
  const pool = POOLS_MAP[poolName as PoolName]
  const newAcc = { ...acc }
...
export const SYNTH_TRACKING_ID = "0x534144444c450000000000000000000000000000000000000000000000000000"
...
export const AGGREGATOR_ADDRESSES: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: "0x05F2F176b491ec11555cbE45B99748F999E13933",
  [ChainId.HARDHAT]: "0x05F2F176b491ec11555cbE45B99748F999E13933", //ZERO_ADDRESS,
}
