...
export const RPC_URLS = {
  [EVM_CHAINIDS.ETHEREUM]: 'https://mainnet.infura.io/v3/',
  [EVM_CHAINIDS.BSC]: 'https://bsc-dataseed.binance.org/',
  [EVM_CHAINIDS.MATIC]: 'https://rpc-mainnet.maticvigil.com/',
  [EVM_CHAINIDS.AVALANCHE]: 'https://api.avax.network/ext/bc/C/rpc',
  [EVM_CHAINIDS.FANTOM]: 'https://rpc.ftm.tools/',
  [EVM_CHAINIDS.ARBITRUM]: 'https://arb1.arbitrum.io/rpc',
  [EVM_CHAINIDS.MOONRIVER]: 'https://moonriver.api.onfinality.io/public',
  [EVM_CHAINIDS.BOBA]: 'https://mainnet.boba.network',
  [EVM_CHAINIDS.HARMONY]: 'https://api.harmony.one',
}

export const FRAX_ADDRESSES: { [key: string]: string }  = {
  [EVM_CHAINIDS.ETHEREUM]: '0x853d955aCEf822Db058eb8505911ED77F175b99e',
  [EVM_CHAINIDS.BSC]: '0x90C97F71E18723b0Cf0dfa30ee176Ab653E89F40',
  [EVM_CHAINIDS.MATIC]: '0x45c32fA6DF82ead1e2EF74d17b76547EDdFaFF89',
  [EVM_CHAINIDS.AVALANCHE]: '0xD24C2Ad096400B6FBcd2ad8B24E7acBc21A1da64',
  [EVM_CHAINIDS.FANTOM]: '0xdc301622e621166BD8E82f2cA0A26c13Ad0BE355',
  [EVM_CHAINIDS.ARBITRUM]: '0x17FC002b466eEc40DaE837Fc4bE5c67993ddBd6F',
  [EVM_CHAINIDS.MOONRIVER]: '0x1A93B23281CC1CDE4C4741353F3064709A16197d',
  [EVM_CHAINIDS.BOBA]: '0x7562F525106F5d54E891e005867Bf489B5988CD9',
  [EVM_CHAINIDS.HARMONY]: '0xFa7191D292d5633f702B0bd7E3E3BcCC0e633200',
}
