export enum CssVariables {
  ...
  primaryHoverStroke = "var(--primaryHoverStroke)",
  primaryDisabled = "var(--primaryDisabled)",
  primaryDisabledStroke = "var(--primaryDisabledStroke)",
  primaryPressed = "var(--primaryPressed)",
  primaryPressedStroke = "var(--primaryPressedStroke)",
  warning = "var(--warning)",
  ...
  secondaryHoverStroke = "var(--secondaryHoverStroke)",
  secondaryDisabled = "var(--secondaryDisabled)",
  secondaryDisabledStroke = "var(--secondaryDisabledStroke)",
  secondaryPressed = "var(--secondaryPressed)",
  secondaryPressedStroke = "var(--secondaryPressedStroke)",
  red = "var(--red)",
  mildRed = "var(--mildRed)",
