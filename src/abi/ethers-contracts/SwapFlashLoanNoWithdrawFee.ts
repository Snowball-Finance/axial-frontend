...
export interface SwapFlashLoanNoWithdrawFeeInterface extends utils.Interface {
  contractName: "SwapFlashLoanNoWithdrawFee";
  functions: {
...
export interface SwapFlashLoanNoWithdrawFee extends BaseContract {
  contractName: "SwapFlashLoanNoWithdrawFee";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapFlashLoanNoWithdrawFeeInterface;
