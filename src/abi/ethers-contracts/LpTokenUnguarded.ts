...
export interface LpTokenUnguardedInterface extends utils.Interface {
  contractName: "LpTokenUnguarded";
  functions: {
...
export interface LpTokenUnguarded extends BaseContract {
  contractName: "LpTokenUnguarded";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LpTokenUnguardedInterface;
