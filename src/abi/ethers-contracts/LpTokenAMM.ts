...
export interface LpTokenAMMInterface extends utils.Interface {
  contractName: "LpTokenAMM";
  functions: {
...
export interface LpTokenAMM extends BaseContract {
  contractName: "LpTokenAMM";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LpTokenAMMInterface;
