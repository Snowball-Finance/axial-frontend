...
import type {
  ...
  SynthetixExchangeRateInterface,
} from "../SynthetixExchangeRate";
...
export class SynthetixExchangeRate__factory {
  ...
  static createInterface(): SynthetixExchangeRateInterface {
    return new utils.Interface(_abi) as SynthetixExchangeRateInterface;
  }
  static connect(
    address: string,
