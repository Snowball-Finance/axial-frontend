...
export interface UniswapLPInterface extends utils.Interface {
  contractName: "UniswapLP";
  functions: {
...
export interface UniswapLP extends BaseContract {
  contractName: "UniswapLP";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapLPInterface;
