...
const slippageCustomStateCreator = numberInputStateCreator(4, BigNumber.from(10).pow(4).mul(1))

const userSlice = createSlice({
  name: "user",
  initialState,
  reducers: {
    updateSwapAdvancedMode(state: UserState, action: PayloadAction<boolean>): void {
      state.userSwapAdvancedMode = action.payload
    },
    updatePoolAdvancedMode(state: UserState, action: PayloadAction<boolean>): void {
    ...
    updateGasPriceCustom(state: UserState, action: PayloadAction<string>): void {
      state.gasCustom = gasCustomStateCreator(action.payload)
    },
    updateGasPriceSelected(state: UserState, action: PayloadAction<GasPrices>): void {
    ...
    updateSlippageSelected(state: UserState, action: PayloadAction<Slippages>): void {
    ...
    updateSlippageCustom(state: UserState, action: PayloadAction<string>): void {
      state.slippageCustom = slippageCustomStateCreator(action.payload)
    },
    updateInfiniteApproval(state: UserState, action: PayloadAction<boolean>): void {
      state.infiniteApproval = action.payload
    },
    updateTransactionDeadlineSelected(state: UserState, action: PayloadAction<Deadlines>): void {
    ...
    updateTransactionDeadlineCustom(state: UserState, action: PayloadAction<string>): void {
