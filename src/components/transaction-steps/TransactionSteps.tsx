    ...
    return (
      <div className="oneLine">
          ...
          <div className="oneLine">
            {(transactionData?.from?.items || []).map((item) => (
              <div key={item.token.symbol} className="stepItem">
                <div
                  className={
                    transactionStatus?.approve?.[item.token.symbol]
                      ? "dot checked"
                      : "dot unchecked"
                  }
                />
        ...
        <div className="stepItem">
          ...
          <div
            className={
              transactionStatus?.deposit ? "dot checked" : "dot unchecked"
            }
          />
        </div>
      </div>
    ...
    return (
      <div className="oneLine">
          ...
          <div className="oneLine">
            {Object.keys(transactionStatus?.approve || {}).map((key) => (
              <div key={key} className="stepItem">
                <div
                  className={
                    transactionStatus?.approve?.[key]
                      ? "dot checked"
                      : "dot unchecked"
                  }
                />
                <img
                  src={POOLS_MAP[key].lpToken.icon}
                  className="tokenIcon"
                  alt="token-icon"
                />
        ...
        <div className="stepItem">
          ...
          <div
            className={
              transactionStatus?.withdraw ? "dot checked" : "dot unchecked"
            }
          />
        </div>
      </div>
